<!DOCTYPE html>
	<html>
		<head>
			...
			<title> Site Personnelle Minecraft </title>
			<link rel="stylesheet" type="text/css" href="style/css/style.css">
			<link href="style/css/cssBootstrap/bootstrap.css" rel="stylesheet">
		</head>
		<body>
			<div class="container">
								<!-- Banniere -->
				...
				<div class="row">
					<div class="col-md-12" id="colonne3">
						<center> <u> <h1> Lien Utiles </h1> </u> </center>
						<center> <p>
						<a href="http://elegeia.forumgratuit.org/forum"> Forum SWTOR </a> </br>
						<strong> Profil mumble : </strong> Adresse: mumble8.verygames.net </br> <span>  ou </span> </br> elegeia.mumble.vg </br>
											Port : 50588 </br>
											Mot de passe : togruta </br>
						</p> </center>
					</div>
				</div>
				<?php
